...
class GridEasy3 extends StatefulWidget {
  const GridEasy3({Key? key}) : super(key: key);

  @override
  _GridEasy1State createState() => _GridEasy1State();
}

class _GridEasy1State extends State<GridEasy3> {

  List<int?> boxValues = List.generate(16, (_) => null);
  List<int> trianglesList = [18, 15, 10, 23, 13, 7];
