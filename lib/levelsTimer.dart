...
import 'mode.dart';
import 'easyTimer.dart';
import 'mediumTimer.dart';
import 'hardTimer.dart';
import 'settings.dart';

void main() {
  runApp(const LevelsTimer());
}

class LevelsTimer extends StatelessWidget {
  const LevelsTimer({Key? key}) : super(key: key);
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Builder(
                  builder: (context) {
                    return ElevatedButton(
                      onPressed: () {Navigator.push( context,MaterialPageRoute(builder: (context) => EasyTimer()),);},
              ...
              Builder(
                  builder: (context) {
                    return ElevatedButton(
                      onPressed: () {Navigator.push( context,MaterialPageRoute(builder: (context) => MediumTimer()),);},
              ...
              Builder(
                  builder: (context) {
                    return ElevatedButton(
                      onPressed: () {Navigator.push( context,MaterialPageRoute(builder: (context) => HardTimer()),);},
