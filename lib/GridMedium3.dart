...
class GridMedium3 extends StatefulWidget {
  const GridMedium3({Key? key}) : super(key: key);

  @override
  _GridMedium3State createState() => _GridMedium3State();
}

class _GridMedium3State extends State<GridMedium3> {
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      TextButton(
                                        ...
                                        onPressed: () {
                                          Navigator.push( context,MaterialPageRoute(builder: (context) => GridMedium4()),);
                                        },
                                        style: ElevatedButton.styleFrom(
                                          primary: Colors.transparent,
                                          elevation: 0,
