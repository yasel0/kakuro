...
class GridEasyTimer3 extends StatefulWidget {
  const GridEasyTimer3({Key? key}) : super(key: key);

  @override
  _GridEasyTimer3State createState() => _GridEasyTimer3State();
}

class _GridEasyTimer3State extends State<GridEasyTimer3> {
  List<int?> boxValues = List.generate(16, (_) => null);
  List<int> trianglesList = [23,19, 10, 23, 19, 10];
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          TextButton(
                                            ...
                                            onPressed: () {
                                              Navigator.push(context, MaterialPageRoute(builder:(context) => const GridEasyTimer4()));
                                            },
                                            style: ElevatedButton.styleFrom(
                                              primary: Colors.transparent,
                                              elevation: 0,
