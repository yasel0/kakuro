...
class GridEasyTimer4 extends StatefulWidget {
  const GridEasyTimer4({Key? key}) : super(key: key);

  @override
  _GridEasyTimer4State createState() => _GridEasyTimer4State();
}

class _GridEasyTimer4State extends State<GridEasyTimer4> {
  List<int?> boxValues = List.generate(16, (_) => null);
  List<int> trianglesList = [24, 11, 10, 23, 12, 10];
