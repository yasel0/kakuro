...
class GridEasy4 extends StatefulWidget {
  const GridEasy4({Key? key}) : super(key: key);

  @override
  _GridEasy1State createState() => _GridEasy1State();
}

class _GridEasy1State extends State<GridEasy4> {

  List<int?> boxValues = List.generate(16, (_) => null);
  List<int> trianglesList = [22, 17, 7, 20, 18, 8];
