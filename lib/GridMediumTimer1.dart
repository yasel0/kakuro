...
class GridMediumTimer1 extends StatefulWidget {
  const GridMediumTimer1({Key? key}) : super(key: key);

  @override
  _GridMediumTimer1State createState() => _GridMediumTimer1State();
}

class _GridMediumTimer1State extends State<GridMediumTimer1> {
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        TextButton(
                                          ...
                                          onPressed: () {
                                            Navigator.push(context, MaterialPageRoute(builder:(context) => const GridMediumTimer2()));
                                          },
                                          style: ElevatedButton.styleFrom(
                                            primary: Colors.transparent,
                                            elevation: 0,
