...
class GridHardTimer2 extends StatefulWidget {
  const GridHardTimer2({Key? key}) : super(key: key);

  @override
  _GridHardTimer2State createState() => _GridHardTimer2State();
}
class _GridHardTimer2State  extends State<GridHardTimer2> {
  List<int?> boxValues = List.generate(72, (_) => null);

  //borders
  List<int> trianglesList = [7,13,14,12,5,13,5,21,26,17,4,21,10,12,7,20,14,28,6,11,5,13,11,8,10];
