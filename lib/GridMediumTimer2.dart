...
class GridMediumTimer2 extends StatefulWidget {
  const GridMediumTimer2({Key? key}) : super(key: key);

  @override
  _GridMediumTimer2State createState() => _GridMediumTimer2State();
}

class _GridMediumTimer2State extends State<GridMediumTimer2> {
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        TextButton(
                                          ...
                                          onPressed: () {
                                            Navigator.push(context, MaterialPageRoute(builder:(context) => const GridMediumTimer3()));
                                          },
                                          style: ElevatedButton.styleFrom(
                                            primary: Colors.transparent,
                                            elevation: 0,
