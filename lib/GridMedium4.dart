...
import 'GridMediumTimer1.dart';
import 'medium.dart';

class GridMedium4 extends StatefulWidget {
  const GridMedium4({Key? key}) : super(key: key);

  @override
  _GridMedium4State createState() => _GridMedium4State();
}

class _GridMedium4State extends State<GridMedium4> {
  List<int?> boxValues = List.generate(25, (_) => null);

  //borders
  List<int> trianglesList =  [13,22,29,10,22,8,23,17];
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      TextButton(
                                        ...
                                        onPressed: () {
                                          Navigator.push( context,MaterialPageRoute(builder: (context) => GridHard1()),);
                                        },
                                        style: ElevatedButton.styleFrom(
                                          primary: Colors.transparent,
                                          elevation: 0,
