...
class GridEasy2 extends StatefulWidget {
  const GridEasy2({Key? key}) : super(key: key);

  @override
  _GridEasy1State createState() => _GridEasy1State();
}

class _GridEasy1State extends State<GridEasy2> {

  List<int?> boxValues = List.generate(16, (_) => null);
  List<int> trianglesList = [15, 11, 10, 23, 7,6];
